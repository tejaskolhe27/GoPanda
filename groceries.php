...
<style>
    ...
    <head>
        <meta charset="utf-8">
        <title>GROCERIES AND ESSENTIAL</title>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav ml-auto">
                    ...
                    <a href="menu.html" class="nav-item nav-link active">Home</a>
					<div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
								...
								<a href="restro.php" class="dropdown-item">Restaurant</a>
...
<div>
<center><h4>GROCERIES AND ESSENTIAL</h4></center>
<br><br>
 ...
 <!-- Displaying Products Start -->
    ...
    <div class="row mt-2 pb-3">
      <?php
  			include 'dbcon.php';
  			$stmt = $conn->prepare("SELECT * FROM product where cat_id='1'");
  			$stmt->execute();
            ...
            <div class="card-footer p-1">
              <form action="" class="form-submit">
                <div class="row p-2">
                  ...
                  <div class="col-md-6">
                    <input type="number" class="form-control pqty" required value="<?= $row['product_qty'] ?>">
                  </div>
                </div>
